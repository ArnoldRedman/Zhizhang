...
## 主线推进
承接自：上一章结尾留下的状态（一句话）
本章推进的总纲节点：____（对照总纲“本章位置”写出本章是本阶段第几章、把主线推进到本阶段的哪一步；总纲没给本章位置时，以本章章纲或阶段节拍表定的事件为准）
时间与地点位移：____（相对上一章：紧接 / 数小时后 / 次日 / 数日后；同一地点 / 换地点。上一章的场景只占开场，不超过全章两成）
与前文的区别：____（本章核心事件必须是故事账本里没有发生过的新推进，不得重写旧事件）
本章走的是哪条线：____（事业 / 生活 / 关系 / 配角线之一。同一条事件线——同一份文件、同一次交涉、同一个物件、同一个悬案、同一批试制样品——最多连续占两章，第三章起必须换线，并把前面这条线推出一个结果：交付、签约、翻脸、公开、结案，而不是这条线上的又一个细节）
本阶段此前没写过的新东西：____（至少写一处：新场地、新行业环节、新配角、新的日常场景，如饭桌、通勤、节庆、门市、家宴。新人物与新地点标“待揭示”，不得与世界观、硬事实账本和既定人物关系冲突）

## 核心爽点类型
主：从打脸、升级、得宝、揭秘、装逼、复仇、收女、差异感、低调装逼、异性倾慕、事业成果、生活流温情、情感推进中选择。
副：从上述类型中选择。本章节拍或总纲位置没有安排揭秘时，不得选揭秘，也不得凭空制造新谜团；但可以写新的日常、事业、关系事件与新登场的次要人物，不必是悬案。
